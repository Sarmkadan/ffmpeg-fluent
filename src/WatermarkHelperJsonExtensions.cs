...
namespace FFmpegFluent
{
    ...
    public static class WatermarkHelperJsonExtensions
    {
        ...
        /// <summary>
        /// Serializes a <see cref="WatermarkHelper"/> instance to a JSON string.
        /// </summary>
        ...
        /// <summary>
        /// Deserializes a <see cref="WatermarkHelper"/> instance from a JSON string.
        /// </summary>
        /// <param name="json">The JSON string to deserialize.</param>
        /// <returns>The deserialized <see cref="WatermarkHelper"/> instance, or null if deserialization fails.</returns>
        ...
        /// <summary>
        /// Attempts to deserialize a <see cref="WatermarkHelper"/> instance from a JSON string.
        /// </summary>
        /// <param name="json">The JSON string to deserialize.</param>
